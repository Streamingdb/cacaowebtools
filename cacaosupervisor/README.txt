...
ATTENTION:
Pour fonctionner, CacaoSupervisor necessite 3 logiciels tiers:

- Choose32.exe par Bill Stewart est un outils qui permet de faire des choix en ligne de commande.
site officiel: 
...
- txtcolor.exe est un outils qui permet d'afficher le texte en couleur sur plusieurs lignes.
Site officiel, sources en C: 
http://groups.google.com/group/alt.msdos.batch.nt
Rechercher "txtcolor.exe carlos" avec votre moteur de recherche si le lien n'est plus valide.
